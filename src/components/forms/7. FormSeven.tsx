...
const FormSeven: React.FC<FormSevenProps> = ({
  thesisData,
  programChair,
  dean,
}) => {
    ...
    <div className="w-full px-16 py-8 font-inter bg-white shadow-lg rounded-lg mx-auto text-sm leading-normal flex flex-col">
      <div className="text-center mb-6">
        <h1 className="font-bold text-lg uppercase mt-2">
          Thesis/Dissertation Proposal Defense Endorsement Form
        </h1>
      </div>
      ...
      <p className="text-justify mb-4">
        ...
        aforementioned thesis/ dissertation is now recommended for Proposal
        Defense.
      </p>
