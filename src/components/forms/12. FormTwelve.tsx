...
const FormTwelve: React.FC<FormTwelveProps> = ({ thesisData, programChair }) => {
    ...
    return (
        <div className="w-full px-16 font-inter bg-white shadow-lg rounded-lg mx-auto text-sm leading-normal flex flex-col">
            <div className="text-center mb-6">
                <h1 className="font-bold text-lg uppercase mt-2">Thesis/Dissertation Final Endorsement Form</h1>
            </div>
            ...
            <p className="text-justify mb-4">
                ...
                dissertation is now recommended for Final Defense.
            </p>
            ...
            <div className="mt-8 grid grid-cols-2 gap-x-16">
                <div>
                    ...
                    <p className="text-xs text-center">(Program Chairperson/Date of Signing)</p>
                </div>
                <div>
