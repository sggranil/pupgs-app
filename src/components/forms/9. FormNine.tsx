...
const FormNine: React.FC<FormNineProps> = ({
  thesisData,
  programChair,
  dean,
}) => {
    ...
    <div className="w-full px-16 py-8 font-inter bg-white shadow-lg rounded-lg mx-auto text-sm leading-normal flex flex-col">
      <div className="text-center mb-6">
        <h1 className="font-bold text-lg uppercase mt-2">
          Thesis/Dissertation Pre-Final Endorsement Form
        </h1>
      </div>
      ...
      <p className="text-justify mb-4">
        ...
        aforementioned thesis/ dissertation is now recommended for Pre-Final
        Defense.
      </p>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center mb-1 ml-4">
          ...
          <p>Pre-Final Defense Manuscript</p>
        </div>
        <div className="flex items-center mb-1 ml-4">
          <span className="border border-black w-4 h-4 flex-shrink-0 mr-2 flex items-center justify-center text-xs pb-0.5">
            &nbsp;
          </span>
          <p>Minutes of Proposal Defense</p>
        </div>
        <div className="flex items-center mb-1 ml-4">
          <span className="border border-black w-4 h-4 flex-shrink-0 mr-2 flex items-center justify-center text-xs pb-0.5">
            &nbsp;
          </span>
          <p>Similary Check Results from IPMO</p>
        </div>
      </div>
