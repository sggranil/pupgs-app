...
const FormNine: React.FC<FormNineProps> = ({ thesisData, programChair }) => {
    ...
    return (
        <div className="w-full px-16 py-8 font-inter bg-white shadow-lg rounded-lg mx-auto text-sm leading-normal flex flex-col">
            <div className="text-center mb-6">
                <h1 className="font-bold text-lg uppercase mt-2">Thesis/Dissertation Pre-Final Endorsement Form</h1>
            </div>
            ...
            <p className="text-justify mb-4">
                ...
                dissertation is now recommended for Pre-Final Defense.
            </p>
