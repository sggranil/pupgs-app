...
const UsersTable = () => {
    ...
    return (
        <div className="w-full">
            ...
            <table className="min-w-full mt-2 bg-white border border-gray-200 rounded-md shadow-md">
                <thead className="bg-gray-100 border-b">
                    <tr>
                        ...
                        <th className="p-3 text-left text-sm font-semibold text-gray-700">Position</th>
                        <th className="p-3 text-left text-sm font-semibold text-gray-700">Department</th>
                        {userData?.role === "admin" && (
                            <th className="p-3 text-left text-sm font-semibold text-gray-700">Admin</th>
                        )}
            ...
            <Modal title="Edit User" isModalOpen={isModalOpen} setModalOpen={setIsModalOpen}>
                <EditProfile
            ...
            <Modal title="Add Adviser" isModalOpen={isAddAdviserModalOpen} setModalOpen={setIsAddAdviserModalOpen}>
                <AddUserModal
