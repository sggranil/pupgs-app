...
const AddRoomModal: React.FC<AddRoomModalProps> = ({ setIsModalOpen, setUpdateCounter }) => {
  ...
  return (
    <form onSubmit={onAddRoom}>
      <div className="w-full py-4">
        <div className="mb-4">
          <label className="block text-textPrimary font-semibold mb-1">Room Name *</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-textPrimary font-semibold mb-1">Location</label>
          <input
            type="text"
            className="w-full p-2 border border-gray-300 rounded-md text-textPrimary bg-white"
            {...register("location")}
        ...
        <div className="mb-4">
          <label className="block text-textPrimary font-semibold mb-1">Capacity</label>
          <input
            type="number"
            min="0"
            className="w-full p-2 border border-gray-300 rounded-md text-textPrimary bg-white"
