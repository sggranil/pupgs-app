    ...
    <div className="p-8 font-inter bg-white shadow-lg rounded-lg w-[1344px] mx-auto">
      <div className="mb-6">
        <div className="flex flex-col md:flex-row items-start md:items-center mb-4 flex-wrap">
          <p className="font-bold text-base mr-2 mb-2 md:mb-0">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center flex-wrap justify-between mt-6">
          <p className="font-bold text-base mr-4 mb-2 md:mb-0">
            Phase of Thesis/Dissertation Writing:
          </p>
        ...
        <table className="min-w-full border border-gray-300">
          <thead className="bg-gray-50">
            <tr>
              <th
                scope="col"
                className="px-3 py-2 text-left text-[11px] font-medium text-gray-700 uppercase tracking-wider w-1/4 border border-gray-300">
                Contact Details:
              </th>
              <th
                scope="col"
                className="px-3 py-2 text-left text-[11px] font-medium text-gray-700 uppercase tracking-wider w-1/3 border border-gray-300">
                Student/Candidate
              </th>
              <th
                scope="col"
          ...
          <tbody className="bg-white">
            <tr>
              <td className="px-3 py-2 whitespace-nowrap text-[11px] text-gray-900 border border-gray-300">
                Phone Number
              </td>
              <td className="px-3 py-2 whitespace-nowrap text-[11px] text-gray-500 border border-gray-300">
                {thesisData?.student?.user?.tel_number}
              </td>
              <td className="px-3 py-2 whitespace-nowrap text-[11px] text-gray-500 border border-gray-300">
                {thesisData?.adviser?.user?.tel_number}
              </td>
            </tr>
            <tr>
              <td className="px-3 py-2 whitespace-nowrap text-[11px] text-gray-900 border border-gray-300">
              ...
              <td className="px-3 py-2 whitespace-nowrap text-[11px] text-gray-500 border border-gray-300">
                {thesisData?.student?.user?.email}
              </td>
              <td className="px-3 py-2 whitespace-nowrap text-[11px] text-gray-500 border border-gray-300">
                {thesisData?.adviser?.user?.email}
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="min-w-full border border-gray-300">
          <thead className="bg-gray-50">
            <tr>
              <th
                scope="col"
                className="px-6 py-3 text-left text-[11px] font-medium text-gray-700 uppercase tracking-wider w-[20%] border border-gray-300">
              ...
              <th
                scope="col"
                className="px-6 py-3 text-left text-[11px] font-medium text-gray-700 uppercase tracking-wider w-[40%] border border-gray-300">
          ...
          <tbody className="bg-white">
            {[...Array(5)].map((_, index) => (
              <tr key={index}>
                <td className="px-6 py-4 whitespace-nowrap text-[11px] text-gray-500 h-20 border border-gray-300">
                  &nbsp;
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-[11px] text-gray-500 h-20 border border-gray-300">
                  &nbsp;
                </td>
                <td className="px-6 py-4 text-[11px] text-gray-500 h-20 border border-gray-300">
                  &nbsp;
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-[11px] text-gray-500 h-20 border border-gray-300">
                  &nbsp;
