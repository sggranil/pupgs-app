    ...
    <div className="w-full px-16 font-inter bg-white shadow-lg rounded-lg mx-auto text-sm leading-normal flex flex-col">
      <div className="text-center mb-6">
        <h1 className="font-bold text-lg uppercase mt-2">
          Thesis/Dissertation Pre-Final Evaluation Sheet
        </h1>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="mb-2">
          ...
          <div className="ml-4">
            <p className="mb-1">
              Adviser:{" "}
              <span className="pb-4 border-b border-black px-2 pb-0.5 min-w-[200px] inline-block">
            ...
            <p className="mb-1">
              ...
              {thesisData?.panelists?.map((panelist, index) => (
                <React.Fragment key={panelist.id || index}>
                  <span className="pb-4 border-b border-black px-2 pb-0.5 min-w-[200px] inline-block ml-20">
                    {getFullAdviserName(panelist)}
                  </span>
                  {index < thesisData.panelists.length - 1 && <br />}{" "}
                  {/* Add line break for multiple evaluators */}
                </React.Fragment>
              ))}
              {(!thesisData?.panelists ||
                thesisData.panelists.length === 0) && (
                <>
                  <span className="border-b border-black px-2 pb-0.5 min-w-[200px] inline-block ml-2">
                    &nbsp;
                  </span>
                  <span className="border-b border-black px-2 pb-0.5 min-w-[200px] inline-block ml-2">
                    &nbsp;
        ...
        <div className="mb-2">
          ...
          <p className="border-b border-black w-full inline-block px-2 pb-0.5 mt-1">
            &nbsp;
          </p>
          <p className="border-b border-black w-full inline-block px-2 pb-0.5 mt-1">
            &nbsp;
          ...
          <p className="border-b border-black w-full inline-block px-2 pb-0.5 mt-1 mb-2">
            &nbsp;
          </p>
        </div>
      </div>
      ...
      <p className="font-bold mb-2">
        General observations for approval/disapproval:
      </p>
      <p className="border-b border-black w-full inline-block px-2 pb-0.5 mt-1">
        &nbsp;
      </p>
      <p className="border-b border-black w-full inline-block px-2 pb-0.5 mt-1 mb-4">
        &nbsp;
      </p>
      ...
      <div className="mt-4 text-center">
        <p className="border-b border-black w-full inline-block">
          {formattedDate}
        </p>
