  ...
  const getFullAdviserName = (adviser: Adviser | undefined) => {
    return adviser
      ? `${adviser.user.first_name || ""} ${
          adviser.user.middle_name ? adviser.user.middle_name + " " : ""
    ...
    <div className="w-full px-16 py-8 font-inter bg-white shadow-lg rounded-lg mx-auto text-sm leading-normal flex flex-col">
      <div className="text-center mb-6">
        <h1 className="font-bold text-lg uppercase mt-2">
          Thesis / Dissertation Proposal Defense Evaluation Sheet
        </h1>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="mb-2">
          ...
          <div className="ml-4">
            <p className="mb-1">
              Adviser:{" "}
              <span className="pb-4 border-b border-black px-2 pb-0.5 min-w-[100px] inline-block">
                {getFullAdviserName(thesisData?.adviser)}
              </span>
            </p>
            <p className="mb-1">
              ...
              {thesisData?.panelists?.map((panelist, index) => (
                <span
                  ...
                  className="pb-4 border-b border-black px-2 pb-0.5 min-w-[100px] inline-block ml-2">
                  {getFullAdviserName(panelist)}
                </span>
              ))}
              {thesisData?.panelists?.length === 0 && (
                <span className="pb-4 border-b border-black px-2 pb-0.5 min-w-[100px] inline-block ml-2">
                  &nbsp;
                </span>
              )}
            </p>
