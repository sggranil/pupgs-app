    ...
    <div className="flex flex-col gap-4 p-4">
        ...
        <select
          ...
          {TIME_OPTIONS.map((t) => (
            <option
              ...
              {format12Hour(t)}{" "}
              {unavailableTimes.includes(t) && t !== time ? "(Occupied)" : ""}
            </option>
          ))}
        </select>
      </label>
      ...
      <div>
        ...
        <select
          ...
          {adviserData.map((adviser) => (
            <option
              ...
              value={adviser.id}
              disabled={
                selectedAdvisers.length >= 4 &&
                !selectedAdvisers.includes(adviser.id)
              }>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Hold Ctrl/Cmd to select multiple advisers
        </p>
      </div>
